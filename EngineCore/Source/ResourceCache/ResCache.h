...
public:
	...
	void Flush(void);
	void FreeResource(const std::string &sResourceName);

    bool IsUsingDevelopmentDirectories(void) const { CHG_ASSERT(m_file); return m_file->VIsUsingDevelopmentDirectories(); }
