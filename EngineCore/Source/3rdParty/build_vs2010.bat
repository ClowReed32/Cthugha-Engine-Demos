...
devenv libogg-1.3.0\win32\VS2010\libogg_dynamic.sln /build Debug /project libogg_dynamic /projectconfig "Debug|Win32"
devenv libvorbis-1.3.2\win32\VS2010\vorbis_static.sln /build Debug /project libvorbisfile /projectconfig "Debug|Win32"
devenv libvorbis-1.3.2\win32\VS2010\vorbis_dynamic.sln /build Debug /project libvorbisfile /projectconfig "Debug|Win32"
