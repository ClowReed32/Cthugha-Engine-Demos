...
public:
	...
	T const & operator * () const			{ CHG_ASSERT(m_bValid); return * GetT(); }
	T & operator * ()						{ CHG_ASSERT(m_bValid); return * GetT(); }
	T const * const operator -> () const	{ CHG_ASSERT(m_bValid); return GetT(); }
	T		* const operator -> ()			{ CHG_ASSERT(m_bValid); return GetT(); }
