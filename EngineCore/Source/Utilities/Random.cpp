//========================================================================
// Random.cpp -  a useful random number generator class
//
...
unsigned int CHGRandom::Random(unsigned int n)
{
    unsigned long y;
...
void CHGRandom::SetRandomSeed(unsigned int n)
{
...
unsigned int CHGRandom::GetRandomSeed(void)
{
	return(rseed);
}

void CHGRandom::Randomize(void)
{
