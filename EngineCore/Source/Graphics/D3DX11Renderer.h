...
#define ROLLING_VB_SIZE (64 * 1024)	// Max vertex buffer size for draw GUI elements and texts
...
{
    TextureID id;
    int type;	// STRUCTURED_BUFFER_RESOURCE or TEXTURE_RESOURCE
};
...
/*
 *	This class allow to use include directive on shaders
 */
...
/*
*	DirectX11 implementation of renderer abstract class
*/
...
public:
	...
	// Texture Methods. Create a directX11 texture ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	// Render Targets Methods. Create DirectX 11 Render Targets and Depth buffer. /////////////////////////////////////////////////////////////////////////
	TextureID addRenderTarget(const int width, const int height, const int depth, const int mipMapCount, const int arraySize, const FORMAT format, 
		const int msaaSamples = 1, const SamplerStateID samplerState = SS_NONE, UINT flags = 0);
	...
	ShaderID createShader(const char *vsText, const char *gsText, const char *fsText, const char *csText, const char* tcsText, const char* tesText, const int vsLine, 
		const int gsLine, const int fsLine, const int csLine,
	...
	SamplerStateID addSamplerState(const Filter filter, const AddressMode s, const AddressMode t, const AddressMode r, const float lod = 0, const UINT maxAniso = 16, const int compareFunc = 0, 
		const float *border_color = NULL);
	BlendStateID addBlendState(const int srcFactorRGB, const int destFactorRGB, const int srcFactorAlpha, const int destFactorAlpha, const int blendModeRGB, const int blendModeAlpha, 
	...
	FontID addFont(const char *ttfFontFile, const UINT size, const SamplerStateID samplerState = -1); // NOT IMPLEMENTED
	...
	void drawElementsInstanced(const Primitives primitive, const int firstIndex, const int nIndices, const int firstVertex, const int nVertices, UINT uNumInstances, UINT offset);
	///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	void drawTextured(const Primitives primitives, TexVertex *vertices, const UINT nVertices, const TextureID texture, const SamplerStateID samplerState, const BlendStateID blendState, 
		const DepthStateID depthState, const Vec4 *color = NULL);
	///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
protected:
	// Create subresource, rendertarget, depth and unordered access view /////////////////////////////////////////////////////////////////////////////////////////////
...
private:
	// Fill shader slot with current textures and buffers ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	// Simple shaders for render GUI and text ////////////////////////
