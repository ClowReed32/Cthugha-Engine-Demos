...
public:
	...
	bool loadHTEXFromMemory(char *rawBuffer, unsigned int rawSize);
	bool loadDDS(const char *fileName, UINT flags = 0);
	bool loadDDSFromMemory(char *rawBuffer, unsigned int rawSize, UINT flags = 0);
#ifndef NO_HDR
	bool loadHDR(const char *fileName);
	bool loadHDRFromMemory(char *rawBuffer, unsigned int rawSize);
#endif // NO_HDR
#ifndef NO_JPEG
	bool loadJPEG(const char *fileName);
	bool loadJPEGFromMemory(char *rawBuffer, unsigned int rawSize);
#endif // NO_JPEG
#ifndef NO_PNG
	bool loadPNG(const char *fileName);
	bool loadPNGFromMemory(char *rawBuffer, unsigned int rawSize);
#endif // NO_PNG
#ifndef NO_TGA
	bool loadTGA(const char *fileName);
	bool loadTGAFromMemory(char *rawBuffer, unsigned int rawSize);
#endif // NO_TGA
#ifndef NO_BMP
	bool loadBMP(const char *fileName);
	bool loadBMPFromMemory(char *rawBuffer, unsigned int rawSize);
#endif // NO_BMP
#ifndef NO_PCX
	bool loadPCX(const char *fileName);
	bool loadPCXFromMemory(char *rawBuffer, unsigned int rawSize);
#endif // NO_PCX
#ifndef NO_RAW
    bool loadRAWFromMemory(char *rawBuffer, unsigned int rawSize);
    bool loadRAWFromMemory(char *rawBuffer, unsigned int width, unsigned int height, unsigned int byteDepth);
#endif
#ifndef NO_PURE_RAW
	bool loadPureRAWFromMemory(char *rawBuffer, unsigned int rawSize);
#endif
	...
	bool loadImageFromMemory(char *rawBuffer, unsigned int rawSize, std::string format, UINT flags = 0);
